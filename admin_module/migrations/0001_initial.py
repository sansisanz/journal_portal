# Generated by Django 5.0.4 on 2024-06-02 14:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(max_length=50)),
                ('status', models.CharField(max_length=25)),
                ('cover_image', models.ImageField(default='', upload_to='issue_covers/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ea_mobile', models.CharField(default='', max_length=20)),
                ('ea_address', models.CharField(default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_count', models.IntegerField(default=0)),
                ('dept_id', models.ForeignKey(default='1', on_delete=django.db.models.deletion.SET_DEFAULT, to='admin_module.dept_table')),
                ('editor', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='admin_module.ea_table')),
            ],
            options={
